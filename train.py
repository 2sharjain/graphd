...
if gpus:
    try:
        # Only enable memory growth for the first GPU
...
Nmax = 256 #Every graph will be padded with fictive nodes up to Nmax nodes
batch_size = 32
...
train_files = load_dir("./graph_daddy", extension=".tlpb.gz")
#train_files = train_files[:4]
val_files = load_dir("./graph_validation", extension=".tlpb.gz")
